...
/* Custom app background glow */
.stApp {
    background: radial-gradient(circle at 50% 0%, #1e1b4b 0%, #09090b 100%) !important;
    color: #f4f4f5 !important;
}

/* Clean up block containers */
.block-container {
...
/* Movie Card Container columns */
div[data-testid="stColumn"]:has(.movie-title) {
...
div[data-testid="stColumn"]:has(.movie-title):hover {
    transform: translateY(-6px) !important;
    border-color: rgba(139, 92, 246, 0.4) !important;
    box-shadow: 0 12px 40px 0 rgba(139, 92, 246, 0.2) !important;
    background: rgba(255, 255, 255, 0.04) !important;
}

/* Image rounding inside card */
div[data-testid="stColumn"]:has(.movie-title) img {
    border-radius: 8px !important;
}

/* Movie Title styling inside card */
.movie-title {
    font-size: 0.95rem;
    font-weight: 600;
    color: #f4f4f5;
...
/* Button style override inside movie card */
div[data-testid="stColumn"]:has(.movie-title) button {
    width: 100% !important;
...
div[data-testid="stColumn"]:has(.movie-title) button:hover {
